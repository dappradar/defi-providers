...
const V2_START_BLOCK = 253139604;
const V3_START_BLOCK = 253170358;

const SUBGRAPH_ENDPOINT_V2 = `https://api.studio.thegraph.com/query/76181/exchangev2-arbitrum/version/latest`;
const SUBGRAPH_ENDPOINT_V3 = `https://api.studio.thegraph.com/query/76181/exchangev3-arbitrum/version/latest`;
