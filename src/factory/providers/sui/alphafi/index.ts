...
function asIntN(int: string | number, bits = 32): number {
  return Number(BigInt.asIntN(bits, BigInt(int)));
}

async function getStsuiBalances(web3: any): Promise<{ [key: string]: string }> {
  const balances: { [key: string]: string } = {};

  const pool = await web3.getObject(
    '0x1adb343ab351458e151bc392fbf1558b3332467f23bda45ae67cd355a57fd5f5',
  );
  const suiAmount = pool.storage.fields.total_sui_supply;

  formatter.merge(balances, 'sui', suiAmount);

  return balances;
}

async function getAggBalances(web3: any): Promise<{ [key: string]: string }> {
  const balances: { [key: string]: string } = {};
  const ALPHAFI_CETUS_TVL_IDS = [
    {
      ...
      token0Type: suiTokens.USDT,
      token1Type: suiTokens.USDC_WORMHOLE,
    },
    {
      poolID:
    ...
    },
    {
      ...
      token0Type: suiTokens.USDC_WORMHOLE,
      token1Type: suiTokens.SUI,
    },
    {
      poolID:
      ...
      investorID:
        '0x9ae0e56aa0ebc27f9283b321a7f9a453ef9f65aaa626f7d9ee5837726664ecdc',
      token0Type: suiTokens.USDC_WORMHOLE,
      token1Type: suiTokens.WBTC,
    },
    {
      poolID:
    ...
    },
    {
      ...
      token0Type: suiTokens.USDC_CIRCLE,
      token1Type: suiTokens.SUI,
    },
    {
      poolID:
  ...
  const ALPHAFI_BLUEFIN_TVL_IDS = [
    {
      ...
      token0Type: suiTokens.SUI,
      token1Type: suiTokens.USDC_CIRCLE,
    },
    {
      poolID:
    ...
    {
      poolID:
        '0x4043b9e628d0cc6c2e3f322e6a7bddf603a3bcc084992355b55f4c23516bb6ba',
      parentPoolID:
        '0xf0e4772e80800550368973d1f8ab2c9a7241ace8df8770452ee2bf3e3e67b8a1',
      investorID:
        '0x6876c4b19075ee774ca368a4a782c9425cca97251093dafa7ff239a846b3ee30',
      token0Type:
    ...
    {
      poolID:
        '0xd30d849bbddd0c1bc0e2eb552c2dacdf4ae998cc03cd485640eb3db7f456e295',
      parentPoolID:
        '0x7df346f8ef98ad20869ff6d2fc7c43c00403a524987509091b39ce61dde00957',
      investorID:
        '0x43523544dd4e7900ac6aeb8299e1aebd5d72bf7fae97f1a3b988c31e08b1bacc',
      token0Type:
    ...
    {
      poolID:
        '0x2781cca45bd57e1205b46dd439baf5233a0f02c4016e0a6b0d1f84036f47d109',
      parentPoolID:
        '0xbcc6909d2e85c06cf9cbfe5b292da36f5bfa0f314806474bbf6a0bf9744d37ce',
      investorID:
        '0x386445d435618922939a998c59593558d576821b5adceb1279b72731fbefaa38',
      token0Type:
    ...
    {
      poolID:
        '0x20f27f4b4e8de8e11aef5c59a4facc8367a92b24bd8302448bd97efbbaf9fec5',
      parentPoolID:
        '0xee0d89310b7216a8ef86cd2af0dd22382f4be2049cd073603b7099d9846ab4ca',
      investorID:
        '0xe171b8b8270e0e311362d55a0e21d387be6d549af8559f0d6ce3c4dfbb95deb7',
      token0Type:
        '0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL',
      token1Type:
        '0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI',
  ...
  const ALPHAFI_BLUEFIN_AUTOBALANCE_TVL_IDS = [
    ...
    {
      poolID:
        '0xafc0dc5166233af565e30e24755c401ff8958a28a8fdfdbbf407236b67725695',
      parentPoolID:
        '0xa0153768c7ed857ffd8bad4708da873fb7825a6878e5f4c83f5df4c091933e56',
      investorID:
        '0x7a8fc71060975c6e16083c723f376eaf41aab466d0a773c06a68f8f07040998a',
      token0Type: suiTokens.SUI,
      token1Type:
        '0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::lbtc::LBTC',
    },
    ...
    {
      poolID:
        '0xce921f354d7eb15f356b274c55834f9098290f08e1e7f1f49f056a2eecb02cf6',
      parentPoolID:
        '0x62af128423465822e5a0979ccad2b0b5ee50a58c6a2c8ea3dd7fda1cda3cfbe7',
      investorID:
        '0xd26173539584dbce0020a9eb69dc1bf6cfe7b7be8a55e94b2db4e0261d9a5e1d',
      token0Type: suiTokens.suiUSDT,
      token1Type: suiTokens.USDC_CIRCLE,
    },
  ];
  ...
  const ALPHAFI_NAVI_TVL_IDS = [
    ...
    {
      poolID:
        '0x17743a10e89b108fd7c048e7737ce09082e3ef91f416ee93c2566c5dd3f438db',
      tokenType:
        '0xaafb102dd0902f5055cadecd687fb5b71ca82ef0e0285d90afde828ec58ca96b::btc::BTC',
      expo: 8,
    },
    ...
    {
      poolID:
        '0x16a5cc859b1af17b7478c79ff43e67cc5f5e5d257fba21839060dd398a9eb958',
      tokenType: suiTokens.DEEP,
      expo: 6,
    },
  ];
  ...
  const ALPHAFI_NAVI_LOOP_TVL_IDS = [
    ...
    {
      poolID:
        '0xc4caf2d31693974b838ffb83b0c8ae880a6b09ca251a07062cf66453bf3e3ce0',
      investorID:
        '0x3e8937974f3dac64eb8ee9f86a80ccc24852bd2f74d18753d071bbdad73a4c97',
      tokenType:
        '0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI',
      expo: 9,
      protocol: 'NAVI',
  ...
  try {
    for (const {
      ...
      token0Type,
      token1Type,
    } of ALPHAFI_CETUS_TVL_IDS) {
      try {
        const investorObject = await web3.getObject(investorID);
        const poolObject = await web3.getObject(poolID);
        const parentPoolObject = await web3.getObject(parentPoolID);

        web3.addUniV3LikePosition(
          balances,
          token0Type,
          token1Type,
          poolObject.tokensInvested,
          asIntN(investorObject.lower_tick),
          asIntN(investorObject.upper_tick),
          asIntN(parentPoolObject.current_tick_index.fields.bits),
        );
      } catch (error) {}
    }
    ...
    for (const { poolID, tokenType, expo } of ALPHAFI_NAVI_TVL_IDS) {
      try {
        const poolObject = await web3.getObject(poolID);

        const tokensInvested = poolObject.tokensInvested;
        const balance = new BigNumber(tokensInvested).dividedBy(
          new BigNumber(10).pow(9 - expo),
        );

        formatter.merge(balances, tokenType, balance.integerValue().toString());
      } catch (error) {}
    }
    ...
    for (const {
      ...
      token0Type,
      token1Type,
    } of ALPHAFI_BLUEFIN_AUTOBALANCE_TVL_IDS) {
      try {
        const investorObject = await web3.getObject(investorID);
        const poolObject = await web3.getObject(poolID);
        const parentPoolObject = await web3.getObject(parentPoolID);
    ...
    for (const { poolID, tokenType, expo } of ALPHAFI_NAVI_LOOP_TVL_IDS) {
      try {
        const poolObject = await web3.getObject(poolID);
    ...
    for (const { poolID, tokenType, expo } of ALPHAFI_BUCKET_TVL_IDS) {
      try {
        const poolObject = await web3.getObject(poolID);
    ...
    log.error({
      ...
      stack: error?.stack || '',
      detail: 'Error in getAggBalances',
      endpoint: 'getAggBalances',
    });
  }
...
async function getStakingBalances(
  ...
  const ALPHA_COIN_TYPE =
    '0xfe3afec26c59e874f3c1d60b8203cb3852d2bb2aa415df9548b8d688e6683f93::alpha::ALPHA';

  const alphaPoolObject = await web3.getObject(ALPHA_POOL_ID);
  const alphaBalance = alphaPoolObject.alpha_bal;

  formatter.merge(balances, ALPHA_COIN_TYPE, alphaBalance);
...
async function tvl(params: ITvlParams): Promise<Partial<ITvlReturn>> {
  ...
  try {
    const stsuiBalances = await getStsuiBalances(web3);
    balances = formatter.sum([balances, stsuiBalances]);
  } catch (error) {
    log.error({
      message: error?.message || '',
      stack: error?.stack || '',
      detail: 'Error in tvl getStsuiBalances',
      endpoint: 'tvl',
    });
  }

  try {
    const aggBalances = await getAggBalances(web3);
    balances = formatter.sum([balances, aggBalances]);
  } catch (error) {
    log.error({
      message: error?.message || '',
      stack: error?.stack || '',
      detail: 'Error in tvl getAggBalances',
      endpoint: 'tvl',
    });
  }
  ...
  try {
    ...
    log.error({
      message: error?.message || '',
      stack: error?.stack || '',
      detail: 'Error in tvl getStakingBalances',
      endpoint: 'tvl',
    });
  }
