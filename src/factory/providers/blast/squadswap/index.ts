...
const V2_START_BLOCK = 5345079;
const V3_START_BLOCK = 5644236;

const SUBGRAPH_ENDPOINT_V2 = `https://api.studio.thegraph.com/query/76181/exchangev2-blast/version/latest`;
const SUBGRAPH_ENDPOINT_V3 = `https://api.studio.thegraph.com/query/76181/exchangev3-blast/version/latest`;
