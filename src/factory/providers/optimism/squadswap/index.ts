...
const V2_START_BLOCK = 125322305;
const V3_START_BLOCK = 125326692;

const SUBGRAPH_ENDPOINT_V2 = `https://api.studio.thegraph.com/query/76181/exchangev2-optimism/version/latest`;
const SUBGRAPH_ENDPOINT_V3 = `https://api.studio.thegraph.com/query/76181/exchangev3-optimism/version/latest`;
